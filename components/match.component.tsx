...
const MatchComponent = (props: MatchComponentProps) => {
    ...
    const isVenueNameTooLong: boolean = props.match.venue_name ? props.match.venue_name.length > 37 : false;
    ...
    return (
        <div className="pb-8 md:w-96">
            ...
            <div className="grid grid-cols-3 ssm:grid-cols-12 grid-rows-7 ssm:grid-rows-5 grid-flow-col">
                ...
                <div className="flex items-end gap-1.5 col-span-2 ssm:row-span-2 ssm:col-span-4">
                    <img
                ...
                <div className={cn("flex items-start gap-1.5 col-span-2 ssm:row-span-3 ssm:col-span-4")}>
                    <img
